...
export class TalentStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    talentResource.addMethod(
      "POST",
      this.talentHubTable.createLambdaIntegration
    );
    talentResource.addMethod("Get", this.talentHubTable.readLambdaIntegration);
    talentResource.addMethod(
      "PUT",
      this.talentHubTable.updateLambdaIntegration
    );
    talentResource.addMethod(
      "DELETE",
      this.talentHubTable.deleteLambdaIntegration
    );
  }
}
